...
namespace Citipay\HPP\Block\Adminhtml\System\Config\Form\Field\Link;

use Magento\Config\Block\System\Config\Form\Field;
use Magento\Framework\Data\Form\Element\AbstractElement;

/**
 * Frontend model for log download button for Citipay
 */
class DownloadLogs extends Field
{
    ...
    protected function _getElementHtml(AbstractElement $element): string
    {
        return sprintf(
            ...
            rtrim($this->_urlBuilder->getUrl('citipayhpp/downloadlogs/download')),
            __('Download Logs')
        );
    }
}
